...
const EndpointBuilder = function() {
    ...
    this.buildUnparsedUri = function(target, resource) {
        let result = '';
    ...
    this.parseUriWithParameters = function(resourceUri, uriParameters) {
        let paramNumber = 0;
    ...
    this.addQueryParams = function(baseUri, queryParams) {
