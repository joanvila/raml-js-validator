...
const paramMappings = require('./param-mappings').paramMappings;

const buildBaseEndpoint = function(target, resourceUri, uriParameters) {
    ...
    while (paramNumber < uriParameters.length) {
        ...
        let replace = paramMappings[paramType];
